...
class BancoINVICOService(
    ...
    def __post_init__(self):
        ...
        super().__init__(
            ...
            filter_schema=BancoINVICOFullFilter,  # <--- LE DECIMOS QUIÉN ES 'F'
        )

    # -------------------------------------------------
    async def add_many(self, data: List[BancoINVICOReport]) -> RouteReturnSchema:
        try:
            ...
            return await sync_validated_to_repository(
                ...
                title="Sincronización SSCC Banco INVICO",
                label="Banco INVICO",
    ...
    # -------------------------------------------------
    async def export(self, params: BancoINVICOLiteFilter) -> StreamingResponse:
        ...
        return self.export_to_excel(
            data_pairs=[(df, "Banco_INVICO")], filename="reporte_banco_invico.xlsx"
        )
