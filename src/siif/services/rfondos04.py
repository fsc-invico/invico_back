...
class Rfondos04Service(
    BaseService[
        Rfondos04Report, Rfondos04Document, Rfondos04FullFilter, Rfondos04LiteFilter
    ]
):
    ...
    def __post_init__(self):
        ...
        super().__init__(
            ...
            filter_schema=Rfondos04FullFilter,  # <--- LE DECIMOS QUIÉN ES 'F'
        )

    # -------------------------------------------------
    async def add_many(self, data: List[Rfondos04Report]) -> RouteReturnSchema:
        try:
            ...
            return await sync_validated_to_repository(
                ...
                title="Sincronización SIIF RFONDOS04",
                label="RFONDOS04",
    ...
    # -------------------------------------------------
    async def export(self, params: Rfondos04LiteFilter) -> StreamingResponse:
        # 1. Creamos el objeto de filtros normal
        search_params = Rfondos04FullFilter(
        ...
        return self.export_to_excel(
            data_pairs=[(df, "SIIF_RFONDOS04")], filename="reporte_rfondos04.xlsx"
        )
