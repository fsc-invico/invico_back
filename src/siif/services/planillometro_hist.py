...
class PlanillometroHistService(
    ...
    def __post_init__(self):
        ...
        super().__init__(
            ...
            filter_schema=PlanillometroHistFullFilter,  # <--- LE DECIMOS QUIÉN ES 'F'
        )

    # -------------------------------------------------
    async def add_many(self, data: List[PlanillometroHistReport]) -> RouteReturnSchema:
        try:
            ...
            return await sync_validated_to_repository(
                ...
                title="Sincronización SIIF Planillometro Historico (Patricia)",
                label="Planillometro Historico",
    ...
    # -------------------------------------------------
    async def export(self, params: PlanillometroHistLiteFilter) -> StreamingResponse:
        # 1. Creamos el objeto de filtros normal
        search_params = PlanillometroHistFullFilter(
