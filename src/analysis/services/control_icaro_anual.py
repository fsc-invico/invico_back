__all__ = ["ControlIcaroAnualService", "ControlIcaroAnualServiceDependency"]
...
from ..repositories import ControlIcaroAnualRepositoryDependency
from ..schemas import (
...
@dataclass
# -------------------------------------------------
class ControlIcaroAnualService(
    BaseService[
        ControlIcaroAnualReport,
        ControlIcaroAnualDocument,
        ControlIcaroAnualFullFilter,
    ...
    repository: ControlIcaroAnualRepositoryDependency
    ...
    def __post_init__(self):
        ...
        super().__init__(
            ...
            filter_schema=ControlIcaroAnualFullFilter,  # <--- LE DECIMOS QUIÉN ES 'F'
        )

    # -------------------------------------------------
    async def add_many(self, data: List[ControlIcaroAnualReport]) -> RouteReturnSchema:
        try:
            # 1. Validar usando tu función genérica
            validation_result = validate_and_extract_data_from_list(
                data_list=data,
                model=ControlIcaroAnualReport,
                field_id=[
                    "ejercicio",
                    "estructura",
                    "fuente",
            ...
            return await sync_validated_to_repository(
                ...
                title="Sincronización Control Icaro Anual",
                label="Control Icaro Anual",
    ...
    # -------------------------------------------------
    async def export(self, params: ControlIcaroAnualLiteFilter) -> StreamingResponse:
        # 1. Creamos el objeto de filtros normal
        search_params = ControlIcaroAnualFullFilter(
...
ControlIcaroAnualServiceDependency = Annotated[ControlIcaroAnualService, Depends()]
