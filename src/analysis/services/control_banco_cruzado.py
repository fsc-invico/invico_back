__all__ = ["ControlBancoCruzadoService", "ControlBancoCruzadoServiceDependency"]
...
from ..repositories import ControlBancoCruzadoRepositoryDependency
from ..schemas import (
...
@dataclass
# -------------------------------------------------
class ControlBancoCruzadoService(
    BaseService[
        ControlBancoCruzadoReport,
        ControlBancoCruzadoDocument,
        ControlBancoCruzadoFullFilter,
    ...
    repository: ControlBancoCruzadoRepositoryDependency
    ...
    def __post_init__(self):
        ...
        super().__init__(
            ...
            filter_schema=ControlBancoCruzadoFullFilter,  # <--- LE DECIMOS QUIÉN ES 'F'
        )

    # -------------------------------------------------
    async def add_many(
        self, data: List[ControlBancoCruzadoReport]
    ) -> RouteReturnSchema:
        try:
            ...
            return await sync_validated_to_repository(
                ...
                title="Sincronización Control Banco Cruzado",
                label="Control Banco Cruzado",
    ...
    # -------------------------------------------------
    async def export(self, params: ControlBancoCruzadoLiteFilter) -> StreamingResponse:
        # 1. Creamos el objeto de filtros normal
        search_params = ControlBancoCruzadoFullFilter(
...
ControlBancoCruzadoServiceDependency = Annotated[ControlBancoCruzadoService, Depends()]
