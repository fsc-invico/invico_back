__all__ = ["ControlIcaroPA6Service", "ControlIcaroPA6ServiceDependency"]
...
from ..repositories import ControlIcaroPA6RepositoryDependency
from ..schemas import (
...
class ControlIcaroPA6Service(
    ...
    repository: ControlIcaroPA6RepositoryDependency
    ...
    def __post_init__(self):
        ...
        super().__init__(
            ...
            filter_schema=ControlIcaroPA6FullFilter,  # <--- LE DECIMOS QUIÉN ES 'F'
        )

    # -------------------------------------------------
    async def add_many(self, data: List[ControlIcaroPA6Report]) -> RouteReturnSchema:
        try:
            # 1. Validar usando tu función genérica
            validation_result = validate_and_extract_data_from_list(
                data_list=data,
                model=ControlIcaroPA6Report,
                field_id=[
                    "ejercicio",
                    "siif_nro_fondo",
                    "icaro_nro_fondo",
            ...
            return await sync_validated_to_repository(
                ...
                title="Sincronización Control Icaro PA6",
                label="Control Icaro PA6",
    ...
    # -------------------------------------------------
    async def export(self, params: ControlIcaroPA6LiteFilter) -> StreamingResponse:
        # 1. Creamos el objeto de filtros normal
        search_params = ControlIcaroPA6FullFilter(
        ...
        return self.export_to_excel(
            data_pairs=[(df, "control_icaro_pa6")],
            filename="reporte_control_icaro_pa6.xlsx",
        )


ControlIcaroPA6ServiceDependency = Annotated[ControlIcaroPA6Service, Depends()]
