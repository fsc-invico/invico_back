__all__ = ["ControlBancoSIIFService", "ControlBancoSIIFServiceDependency"]
...
from ..repositories import ControlBancoSIIFRepositoryDependency
from ..schemas import (
...
class ControlBancoSIIFService(
    ...
    repository: ControlBancoSIIFRepositoryDependency
    ...
    def __post_init__(self):
        ...
        super().__init__(
            ...
            filter_schema=ControlBancoSIIFFullFilter,  # <--- LE DECIMOS QUIÉN ES 'F'
        )

    # -------------------------------------------------
    async def add_many(self, data: List[ControlBancoSIIFReport]) -> RouteReturnSchema:
        try:
            ...
            return await sync_validated_to_repository(
                ...
                title="Sincronización Control Banco SIIF",
                label="Control Banco SIIF",
    ...
    # -------------------------------------------------
    async def export(self, params: ControlBancoSIIFLiteFilter) -> StreamingResponse:
        # 1. Creamos el objeto de filtros normal
        search_params = ControlBancoSIIFFullFilter(
        ...
        return self.export_to_excel(
            data_pairs=[(df, "siif_db")],
            filename="Control Banco SIIF.xlsx",
            upload_to_google_sheets=True,
            spreadsheet_key="1CRQjzIVzHKqsZE8_E1t8aRQDfWfZALhbe64WcxHiSM4",
        )


ControlBancoSIIFServiceDependency = Annotated[ControlBancoSIIFService, Depends()]
