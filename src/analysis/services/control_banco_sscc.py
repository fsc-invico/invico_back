__all__ = ["ControlBancoSSCCService", "ControlBancoSSCCServiceDependency"]
...
from ..repositories import ControlBancoSSCCRepositoryDependency
from ..schemas import (
...
class ControlBancoSSCCService(
    ...
    repository: ControlBancoSSCCRepositoryDependency
    ...
    def __post_init__(self):
        ...
        super().__init__(
            ...
            filter_schema=ControlBancoSSCCFullFilter,  # <--- LE DECIMOS QUIÉN ES 'F'
        )

    # -------------------------------------------------
    async def add_many(self, data: List[ControlBancoSSCCReport]) -> RouteReturnSchema:
        try:
            ...
            return await sync_validated_to_repository(
                ...
                title="Sincronización Control Banco SSCC",
                label="Control Banco SSCC",
    ...
    # -------------------------------------------------
    async def export(self, params: ControlBancoSSCCLiteFilter) -> StreamingResponse:
        # 1. Creamos el objeto de filtros normal
        search_params = ControlBancoSSCCFullFilter(
        ...
        return self.export_to_excel(
            data_pairs=[(df, "sscc_db")],
            filename="Control Banco SSCC.xlsx",
            upload_to_google_sheets=True,
            spreadsheet_key="1CRQjzIVzHKqsZE8_E1t8aRQDfWfZALhbe64WcxHiSM4",
        )


ControlBancoSSCCServiceDependency = Annotated[ControlBancoSSCCService, Depends()]
